...
(function($) {
    ...
    var drawer = (function() {
        ...
        drawer.prototype = {
            ...
            handle: null,
            close: function() {
                this.drawerMove(this.el, {x: 0,y: 0}, 300, "ease-out");
            },
            ...
            touchMove: function(event) {
                try {
                    ...
                    if (this.currentDrawer != null) {
                        ...
                        if (newTop >= Math.abs(this.maxTop))
                            return;
            ...
            touchEnd: function(event) {
                if (this.currentDrawer != null) {
                    ...
                    if (drawerPoints.y == this.maxTop)
                        this.currentDrawer.style.zIndex = "999";
                    else
                        this.currentDrawer.style.zIndex = "1";
